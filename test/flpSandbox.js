		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DemoWorklist",
									"targetURL": "#demoworklist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demoworklist-display": {
								"semanticObject": "demoworklist",
								"action": "display",
								"description": "Demo Worklist Application",
								"title": "DemoWorklist",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.worklist",
									"url": sap.ui.require.toUrl("demo/worklist")
								}
							}
						}
					}
